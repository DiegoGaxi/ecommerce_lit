...
var n = { exports: {} };
var o = n.exports = (/* @__PURE__ */ function() {
  function e2(n2, o2, r2) {
    ...
    for (var s2 = t, a2 = 0; a2 < r2.length; a2++) i2(r2[a2]);
    return i2;
  }
  return e2;
}())({ 1: [function(e2, t2, n2) {
  ...
  t2.exports = function(e3, t3) {
    ...
    function c2(e4, i3) {
      ...
      switch (c3) {
        case "string":
          ...
          break;
        case "weakset":
          if (l3) throw new o2(u3 + "unable to use .deep.include with WeakSet", void 0, p3);
          d2 = a3.has(e4);
          break;
        case "map":
          var y2 = l3 ? t3.eql : s2;
        ...
        case "array":
          ...
          break;
        default:
          if (e4 !== Object(e4)) throw new o2(u3 + "the given combination of arguments (" + c3 + " and " + t3.type(e4).toLowerCase() + ") is invalid for this assertion. You can use an array, a map, an object, a set, a string, or a weakset instead of a " + t3.type(e4).toLowerCase(), void 0, p3);
          var b2 = Object.keys(e4), g2 = null, w2 = 0;
          if (b2.forEach(function(i4) {
            var s3 = new n3(a3);
            if (t3.transferFlags(this, s3, true), r2(s3, "lockSsfi", true), f3 && 1 !== b2.length) try {
              s3.property(i4, e4[i4]);
            } catch (e5) {
              if (!t3.checkError.compatibleConstructor(e5, o2)) throw e5;
              null === g2 && (g2 = e5), w2++;
            }
            else s3.property(i4, e4[i4]);
    ...
    function p2(e4, t4) {
      ...
      } else this.assert(e4 === n4, "expected #{this} to equal #{exp}", "expected #{this} to not equal #{exp}", e4, this._obj, true);
    }
    function l2(e4, n4) {
    ...
    function h2(e4, i3) {
      ...
      if (c3 && "map" !== l3 && "set" !== l3 && new n3(a3, u3, p3, true).to.have.property("length"), c3 || "date" !== l3 || "date" === h3 ? "number" === h3 || !c3 && "number" !== l3 ? c3 || "date" === l3 || "number" === l3 ? d2 = false : s3 = f3 + "expected " + ("string" === l3 ? "'" + a3 + "'" : a3) + " to be a number or a date" : s3 = f3 + "the argument to above must be a number" : s3 = f3 + "the argument to above must be a date", d2) throw new o2(s3, void 0, p3);
      if (c3) {
        var y2, b2 = "length";
      ...
      } else this.assert(a3 > e4, "expected #{this} to be above #{exp}", "expected #{this} to be at most #{exp}", e4);
    }
    function d(e4, i3) {
      i3 && r2(this, "message", i3);
      var s3, a3 = r2(this, "object"), c3 = r2(this, "doLength"), u3 = r2(this, "message"), f3 = u3 ? u3 + ": " : "", p3 = r2(this, "ssfi"), l3 = t3.type(a3).toLowerCase(), h3 = t3.type(e4).toLowerCase(), d2 = true;
      if (c3 && "map" !== l3 && "set" !== l3 && new n3(a3, u3, p3, true).to.have.property("length"), c3 || "date" !== l3 || "date" === h3 ? "number" === h3 || !c3 && "number" !== l3 ? c3 || "date" === l3 || "number" === l3 ? d2 = false : s3 = f3 + "expected " + ("string" === l3 ? "'" + a3 + "'" : a3) + " to be a number or a date" : s3 = f3 + "the argument to least must be a number" : s3 = f3 + "the argument to least must be a date", d2) throw new o2(s3, void 0, p3);
      if (c3) {
        var y2, b2 = "length";
      ...
      } else this.assert(a3 >= e4, "expected #{this} to be at least #{exp}", "expected #{this} to be below #{exp}", e4);
    }
    function y(e4, i3) {
      i3 && r2(this, "message", i3);
      var s3, a3 = r2(this, "object"), c3 = r2(this, "doLength"), u3 = r2(this, "message"), f3 = u3 ? u3 + ": " : "", p3 = r2(this, "ssfi"), l3 = t3.type(a3).toLowerCase(), h3 = t3.type(e4).toLowerCase(), d2 = true;
      if (c3 && "map" !== l3 && "set" !== l3 && new n3(a3, u3, p3, true).to.have.property("length"), c3 || "date" !== l3 || "date" === h3 ? "number" === h3 || !c3 && "number" !== l3 ? c3 || "date" === l3 || "number" === l3 ? d2 = false : s3 = f3 + "expected " + ("string" === l3 ? "'" + a3 + "'" : a3) + " to be a number or a date" : s3 = f3 + "the argument to below must be a number" : s3 = f3 + "the argument to below must be a date", d2) throw new o2(s3, void 0, p3);
      if (c3) {
        var y2, b2 = "length";
      ...
      } else this.assert(a3 < e4, "expected #{this} to be below #{exp}", "expected #{this} to be at least #{exp}", e4);
    }
    function b(e4, i3) {
      i3 && r2(this, "message", i3);
      var s3, a3 = r2(this, "object"), c3 = r2(this, "doLength"), u3 = r2(this, "message"), f3 = u3 ? u3 + ": " : "", p3 = r2(this, "ssfi"), l3 = t3.type(a3).toLowerCase(), h3 = t3.type(e4).toLowerCase(), d2 = true;
      if (c3 && "map" !== l3 && "set" !== l3 && new n3(a3, u3, p3, true).to.have.property("length"), c3 || "date" !== l3 || "date" === h3 ? "number" === h3 || !c3 && "number" !== l3 ? c3 || "date" === l3 || "number" === l3 ? d2 = false : s3 = f3 + "expected " + ("string" === l3 ? "'" + a3 + "'" : a3) + " to be a number or a date" : s3 = f3 + "the argument to most must be a number" : s3 = f3 + "the argument to most must be a date", d2) throw new o2(s3, void 0, p3);
      if (c3) {
        var y2, b2 = "length";
      ...
      } else this.assert(a3 <= e4, "expected #{this} to be at most #{exp}", "expected #{this} to be above #{exp}", e4);
    }
    function g(e4, n4) {
      ...
      try {
        ...
        if (n5 instanceof TypeError) throw new o2((a3 = a3 ? a3 + ": " : "") + "The instanceof assertion needs a constructor but " + t3.type(e4) + " was given.", void 0, s3);
        throw n5;
      }
    ...
    function w(e4, n4, i3) {
      ...
      if (c3 = c3 ? c3 + ": " : "", s3) {
        if ("string" !== p3) throw new o2(c3 + "the argument to property must be a string when using nested syntax", void 0, f3);
      } else if ("string" !== p3 && "number" !== p3 && "symbol" !== p3) throw new o2(c3 + "the argument to property must be a string, number, or symbol", void 0, f3);
      if (s3 && a3) throw new o2(c3 + 'The "nested" and "own" flags cannot be combined.', void 0, f3);
      if (null == u3) throw new o2(c3 + "Target cannot be null or undefined.", void 0, f3);
    ...
    function M(e4) {
      ...
      if ("Map" === a3 || "Set" === a3) p3 = f3 ? "deeply " : "", i3 = [], s3.forEach(function(e5, t4) {
        i3.push(t4);
      }), "Array" !== c3 && (e4 = Array.prototype.slice.call(arguments));
      else {
        switch (i3 = t3.getOwnEnumerableProperties(s3), c3) {
          case "Array":
            if (arguments.length > 1) throw new o2(d2, void 0, u3);
            break;
          case "Object":
            if (arguments.length > 1) throw new o2(d2, void 0, u3);
            e4 = Object.keys(e4);
      ...
      if (!e4.length) throw new o2(h3 + "keys required", void 0, u3);
    ...
    function S(e4, t4, i3) {
      ...
      if (new n3(s3, a3, c3, true).is.a("number"), "number" != typeof e4 || "number" != typeof t4) throw new o2((a3 = a3 ? a3 + ": " : "") + "the arguments to closeTo or approximately must be numbers" + (void 0 === t4 ? ", and a delta is required" : ""), void 0, c3);
    ...
    function k(e4, t4, n4, o3, r3) {
      ...
      return e4.every(function(e5, i3) {
        if (r3) return n4 ? n4(e5, t4[i3]) : e5 === t4[i3];
        if (!n4) {
    ...
    ["to", "be", "been", "is", "and", "has", "have", "with", "that", "which", "at", "of", "same", "but", "does", "still", "also"].forEach(function(e4) {
      ...
      switch (s3 = s3 ? s3 + ": " : "", t3.type(n4).toLowerCase()) {
        ...
        default:
          if (n4 !== Object(n4)) throw new o2(s3 + ".empty was passed non-string primitive " + t3.inspect(n4), void 0, i3);
      ...
      if (u3 && "map" !== h3 && "set" !== h3 && new n3(c3, f3, l3, true).to.have.property("length"), u3 || "date" !== h3 || "date" === d2 && "date" === y2 ? "number" === d2 && "number" === y2 || !u3 && "number" !== h3 ? u3 || "date" === h3 || "number" === h3 ? b2 = false : a3 = p3 + "expected " + ("string" === h3 ? "'" + c3 + "'" : c3) + " to be a number or a date" : a3 = p3 + "the arguments to within must be numbers" : a3 = p3 + "the arguments to within must be dates", b2) throw new o2(a3, void 0, l3);
      if (u3) {
        var w2, m2 = "length";
      ...
      } else this.assert(c3 >= e4 && c3 <= i3, "expected #{this} to be within " + g2, "expected #{this} to not be within " + g2);
  ...
  t2.exports = function(e3, t3) {
    ...
    r2.fail = function(t4, n4, o3, i2) {
      ...
      if (4 === arguments.length && "function" == typeof t4) {
        var a2 = i2;
        i2 = o3, s2 = a2;
      } else 3 === arguments.length && (i2 = o3, o3 = null);
  ...
  t2.exports = function(e3, t3, n3, u3) {
    ...
    e3.__methods || (e3.__methods = {}), e3.__methods[t3] = h2, Object.defineProperty(e3, t3, { get: function() {
      ...
      } else Object.getOwnPropertyNames(e3).forEach(function(t4) {
        if (-1 === f2.indexOf(t4)) {
  ...
  t2.exports = function(e3, t3, n3) {
    ...
    if (3 !== arguments.length) return o2[t3];
    o2[t3] = n3;
  };
  ...
  t2.exports = function(e3) {
    ...
    for (var o2 = Object.getPrototypeOf(e3); null !== o2; ) Object.getOwnPropertyNames(o2).forEach(n3), o2 = Object.getPrototypeOf(o2);
    return t3;
  };
  ...
  function u2(e3, t3, s3) {
    ...
    if (0 === S.length || v(t3) && (1 === S.length && "stack" === S[0] || 2 === S.length && "description" === S[0] && "stack" === S[1])) {
      if ("function" == typeof t3) return N = (P = o2(t3)) ? ": " + P : "", e3.stylize("[Function" + N + "]", "special");
      if (w(t3)) return e3.stylize(RegExp.prototype.toString.call(t3), "regexp");
      if (m(t3)) return e3.stylize(Date.prototype.toUTCString.call(t3), "date");
      if (v(t3)) return p2(t3);
    }
    var k, A = "", D = false, T = false, q = ["{", "}"];
    if (b(t3) && (T = true, q = ["[", "]"]), g(t3) && (D = true, q = ["[", "]"]), "function" == typeof t3 && (A = " [Function" + (N = (P = o2(t3)) ? ": " + P : "") + "]"), w(t3) && (A = " " + RegExp.prototype.toString.call(t3)), m(t3) && (A = " " + Date.prototype.toUTCString.call(t3)), v(t3)) return p2(t3);
    if (0 === S.length && (!D || 0 == t3.length)) return q[0] + A + q[1];
    if (s3 < 0) return w(t3) ? e3.stylize(RegExp.prototype.toString.call(t3), "regexp") : e3.stylize("[Object]", "special");
    if (e3.seen.push(t3), D) k = l2(e3, t3, s3, E, S);
    else {
      if (T) return h2(t3);
      k = S.map(function(n3) {
  ...
  function f2(e3, t3) {
    ...
    if (null === t3) return e3.stylize("null", "null");
  }
  function p2(e3) {
    return "[" + Error.prototype.toString.call(e3) + "]";
  }
  function l2(e3, t3, n3, o3, r3) {
    for (var i3 = [], s3 = 0, a3 = t3.length; s3 < a3; ++s3) Object.prototype.hasOwnProperty.call(t3, String(s3)) ? i3.push(d(e3, t3, n3, o3, String(s3), true)) : i3.push("");
  ...
  t2.exports = function(e3) {
    ...
    if (r2.truncateThreshold && t3.length >= r2.truncateThreshold) {
      if ("[object Function]" === n3) return e3.name && "" !== e3.name ? "[Function: " + e3.name + "]" : "[Function]";
      if ("[object Array]" === n3) return "[ Array(" + e3.length + ") ]";
      if ("[object Object]" === n3) {
  ...
  t2.exports = function(e3, t3, n3) {
    ...
    var f2 = function() {
      ...
      if (i2(this, "lockSsfi", e4), void 0 !== t4) return t4;
  ...
  function c2(e3, t3, n3) {
    if (Math.abs(e3.length - t3.length) >= n3) return n3;
    for (var o3 = [], r3 = 0; r3 <= e3.length; r3++) o3[r3] = Array(t3.length + 1).fill(0), o3[r3][0] = r3;
    for (var i3 = 0; i3 < t3.length; i3++) o3[0][i3] = i3;
    for (r3 = 1; r3 <= e3.length; r3++) {
      var s3 = e3.charCodeAt(r3 - 1);
      for (i3 = 1; i3 <= t3.length; i3++) Math.abs(r3 - i3) >= n3 ? o3[r3][i3] = n3 : o3[r3][i3] = Math.min(o3[r3 - 1][i3] + 1, o3[r3][i3 - 1] + 1, o3[r3 - 1][i3 - 1] + (s3 === t3.charCodeAt(i3 - 1) ? 0 : 1));
    }
  ...
  t2.exports = function(e3, t3) {
    return s2() ? new Proxy(e3, { get: function e4(n3, s3) {
      if ("string" == typeof s3 && -1 === o2.proxyExcludedKeys.indexOf(s3) && !Reflect.has(n3, s3)) {
        if (t3) throw Error("Invalid Chai property: " + t3 + "." + s3 + '. See docs for proper usage of "' + t3 + '".');
        var u2 = null, f2 = 4;
  ...
  t2.exports = function(e3, t3, n3) {
    var o2 = e3.__flags || (e3.__flags = /* @__PURE__ */ Object.create(null));
    for (var r2 in t3.__flags || (t3.__flags = /* @__PURE__ */ Object.create(null)), n3 = 3 !== arguments.length || n3, o2) (n3 || "object" !== r2 && "ssfi" !== r2 && "lockSsfi" !== r2 && "message" != r2) && (t3.__flags[r2] = o2[r2]);
  };
  ...
  function o2() {
    ...
    return function() {
      for (var e4 = [].slice.call(arguments), n3 = 0, o3 = {}; n3 < e4.length; n3++) t3(o3, e4[n3]);
      return o3;
    };
  }
  function r2(e3, t3, n3) {
    var i2 = o2("name", "message", "stack", "constructor", "toJSON")(t3 || {});
    for (var s2 in this.message = e3 || "Unspecified AssertionError", this.showDiff = false, i2) this[s2] = i2[s2];
  ...
  function c2(e3, t3, n3) {
    if (n3 && n3.comparator) return f2(e3, t3, n3);
    var o3 = u2(e3, t3);
  ...
  function f2(e3, t3, n3) {
    ...
    if (r3) {
      var l3 = r3(e3, t3);
      if (false === l3 || true === l3) return a2(e3, t3, n3.memoize, l3), l3;
      var h3 = u2(e3, t3);
      if (null !== h3) return h3;
    }
    var d2 = o2(e3);
    if (d2 !== o2(t3)) return a2(e3, t3, n3.memoize, false), false;
  ...
  function d(e3, t3, n3) {
    var o3 = e3.length;
    if (o3 !== t3.length) return false;
    if (0 === o3) return true;
    for (var r3 = -1; ++r3 < o3; ) if (false === c2(e3[r3], t3[r3], n3)) return false;
    return true;
  }
  function y(e3, t3, n3) {
  ...
  function w(e3) {
    for (var t3 = e3.next(), n3 = [t3.value]; false === t3.done; ) t3 = e3.next(), n3.push(t3.value);
    return n3;
  }
  function m(e3) {
    var t3 = [];
  ...
  function v(e3, t3, n3, o3) {
    var r3 = n3.length;
    if (0 === r3) return true;
    for (var i3 = 0; i3 < r3; i3 += 1) if (false === c2(e3[n3[i3]], t3[n3[i3]], o3)) return false;
    return true;
  }
  function x(e3, t3, n3) {
    var o3 = m(e3), r3 = m(t3);
    if (o3.length && o3.length === r3.length) return o3.sort(), r3.sort(), false !== d(o3, r3) && v(e3, t3, o3, n3);
    var i3 = g(e3), s3 = g(t3);
  ...
  function r2(e3) {
    return e3.replace(/([^\\])\[/g, "$1.[").match(/(\\\.|[^.]+?)+/g).map(function(e4) {
      if ("constructor" === e4 || "__proto__" === e4 || "prototype" === e4) return {};
      var t3 = /^\[(\d+)\]$/.exec(e4);
  ...
  function s2(e3, t3, n3) {
    for (var o3 = e3, r3 = n3.length, i3 = null, s3 = 0; s3 < r3; s3++) {
      var a3 = null, c3 = null;
      if (i3 = n3[s3], s3 === r3 - 1) o3[a3 = void 0 === i3.p ? i3.i : i3.p] = t3;
      else if (void 0 !== i3.p && o3[i3.p]) o3 = o3[i3.p];
      else if (void 0 !== i3.i && o3[i3.i]) o3 = o3[i3.i];
      else {
        var u3 = n3[s3 + 1];
  ...
  !function(e2, t3) {
    ...
    function x(e2) {
      var o4 = typeof e2;
      if ("object" !== o4) return o4;
      if (null === e2) return "null";
      if (e2 === n3) return "global";
      if (Array.isArray(e2) && (false === f2 || !(Symbol.toStringTag in e2))) return "Array";
      if ("object" == typeof window && null !== window) {
        if ("object" == typeof window.location && e2 === window.location) return "Location";
        if ("object" == typeof window.document && e2 === window.document) return "Document";
        if ("object" == typeof window.navigator) {
          if ("object" == typeof window.navigator.mimeTypes && e2 === window.navigator.mimeTypes) return "MimeTypeArray";
          if ("object" == typeof window.navigator.plugins && e2 === window.navigator.plugins) return "PluginArray";
        }
        if (("function" == typeof window.HTMLElement || "object" == typeof window.HTMLElement) && e2 instanceof window.HTMLElement) {
          if ("BLOCKQUOTE" === e2.tagName) return "HTMLQuoteElement";
          if ("TD" === e2.tagName) return "HTMLTableDataCellElement";
          if ("TH" === e2.tagName) return "HTMLTableHeaderCellElement";
        }
      }
...
function getDiffableHTML(html3, options = {}) {
  const ignoreAttributes = (
    /** @type {string[]} */
    options.ignoreAttributes ? options.ignoreAttributes.filter((e2) => typeof e2 === "string") : []
  );
...
`;
  ...
  function isIgnoredAttribute(el) {
    return function isIgnoredElementAttibute(attr) {
      ...
      return !!ignoreAttributesForTags.find((e2) => {
        if (!e2.tags || !e2.attributes) {
          throw new Error(
            `An object entry to ignoreAttributes should contain a 'tags' and an 'attributes' property.`
          );
        }
        return e2.tags.includes(getTagName(el)) && e2.attributes.includes(attr.name);
      });
    };
  }
...
`;
  ...
  if (typeof html3 === "string") {
    ...
    depth = -1;
  } else if (html3 instanceof Node) {
    container = html3;
    depth = 0;
  } else {
    throw new Error(`Cannot create diffable HTML from: ${html3}`);
  }
...
async function getSnapshots({ cache = true } = {}) {
  ...
  if (typeof (result == null ? void 0 : result.content) !== "string") {
...
var chaiDomDiff = (chai2, utils) => {
    ...
    function handleDom(value, ...args) {
      if (utils.flag(this, "lightDom") || utils.flag(this, "shadowDom") || utils.flag(this, "dom")) {
        ...
        if (utils.flag(this, "lightDom")) {
          html3 = getLightDomHtml(this._obj);
        } else if (utils.flag(this, "shadowDom")) {
          html3 = getShadowDomHtml(this._obj);
        } else {
          html3 = getDomHtml(this._obj);
        }
        assertHtmlEquals(html3, value, utils.flag(this, "negate"), args[0]);
      } else {
  ...
  function assertHtmlEqualsSnapshotKarma(actual, negate, ...rest) {
    ...
    const html3 = getDiffableHTML(actual, options);
    if (snapshotState.update) {
      snapshotState.set(path, index, html3, "html");
    } else {
      const snapshot = snapshotState.get(path, index);
      if (!snapshot) {
        snapshotState.set(path, index, html3, "html");
      } else {
        const isMatch = snapshotState.match(html3, getDiffableHTML(snapshot.code, options));
  ...
  function equalSnapshot(options) {
    ...
    if (utils.flag(this, "shadowDom")) {
      html3 = getShadowDomHtml(el);
    } else if (utils.flag(this, "lightDom")) {
      html3 = getLightDomHtml(el);
    } else {
      html3 = el;
    }
    return assertHtmlEqualsSnapshot.call(this, html3, utils.flag(this, "negate"), options);
  }
...
async function loadAxe() {
  ...
  await import("./axe.min-XYODFUEC.js");
  if (!window.axe) {
    throw new Error(
...
(function(module, exports) {
  (function(chaiDom2) {
    ...
    chai2.Assertion.addMethod("html", function(html3) {
      var el = flag(this, "object"), actual = flag(this, "object").innerHTML;
      if (flag(this, "contains")) {
        this.assert(
          actual.indexOf(html3) >= 0,
...
var withStatic = (coreTag) => (strings, ...values) => {
  ...
  while (i2 < l2) {
    s2 = strings[i2];
    while (i2 < l2 && (dynamicValue = values[i2], staticValue = unwrapStaticValue(dynamicValue)) !== void 0) {
...
async function triggerBlurFor(element) {
  if (isIE()) {
    await nextFrame();
    await nextFrame();
  }
...
async function triggerFocusFor(element) {
  if (isIE()) {
    await nextFrame();
    await nextFrame();
  }
...
function oneDefaultPreventedEvent(eventTarget, eventName) {
  return new Promise((resolve) => {
    function listener(ev) {
      ev.preventDefault();
      resolve(ev);
...
function waitUntil(predicate, message, options = {}) {
  const { interval = 50, timeout = 1e3 } = options;
...
function isValidNonIterableRenderArg(x) {
  return isTemplateResult(x) || x instanceof Node || typeof x === "number" || typeof x === "boolean" || typeof x === "string";
}
...
function litFixtureSync(template, options = {}, getScopedElementsTemplate) {
  ...
  const render2 = options.render ?? render;
  render2(
...
async function litFixture(template, options = {}) {
  const getScopedElementsTemplate = options.scopedElements ? await import("./scopedElementsWrapper-URYGABGQ.js").then(
...
function fixtureSync(template, options) {
  if (typeof template === "string") {
    return stringFixtureSync(template, options);
  }
  if (!!(options == null ? void 0 : options.render) || isValidRenderArg(template)) {
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=@open-wc_testing.js.map
